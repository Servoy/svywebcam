...
(function() {
  ...
  JpegCamera = (function() {
    JpegCamera.DefaultOptions = {
      shutter_ogg_url: "svywebcam/webcam/lib/shutter.ogg",
      shutter_mp3_url: "svywebcam/webcam/lib/shutter.mp3",
      swf_url: "svywebcam/webcam/lib/jpeg_camera.swf",
    ...
    JpegCamera.prototype.stop = function() {
        if(navigator.getUserMedia) {
           ...
           var that = this;
           if (that.video && that.video.srcObject) {
        	   that.video.srcObject.getTracks().forEach(function (track) {
				      track.stop();
				      //that.video.srcObject.removeTrack(track);
				  });
           }
        }
        if (!navigator.getUserMedia) {
